...
class Befehl
{
     ...
     *                     'null' sein, wenn dieser src.Befehl als nicht
     *                     vom src.Spiel erkannt gekennzeichnet werden soll.
     ...
     * Wenn der src.Befehl nicht verstanden wurde, ist das Ergebnis
     * 'null'.
    ...
    /**
     * @return  true, wenn dieser src.Befehl nicht verstanden wurde
     */
    ...
    /**
     * @return  true, wenn dieser src.Befehl ein zweites Wort hat
     */
